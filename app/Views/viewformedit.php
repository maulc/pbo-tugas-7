...
<div class="container">
    ...
    <h5 class="text-center">Maula Cahya Amalia (20051214024)</h5>
    <p>
    ...
    <div class="card mt-5">
      ...
      <?= form_open('mahasiswa/simpandata')?>
       <form method="post" action="" >
        ...
        <button type="Submit" class="btn btn-warning" name="bsim" >Simpan</button>

        <button type="reset" class="btn btn-light" name="bres">Kosongkan</button>
